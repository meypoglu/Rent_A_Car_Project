...
public class BookingView extends Layout{
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        btn_book_save.addActionListener(e -> {
            JTextField[] checkFieldList = {this.fld_book_name, this.fld_book_mail, this.fld_book_prc, this.fld_mpno, this.fld_idno, this.fld_book_strt_date, this.fld_book_fnsh_date};
            if (Helper.isFieldListEmpty(checkFieldList)) {
                ...
                book.setIdno(this.fld_idno.getText());
                book.setMpno(this.fld_mpno.getText());
